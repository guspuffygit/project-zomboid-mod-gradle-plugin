...
public class VarExprent extends Exprent {
    ...
    public TextBuffer toJava(int indent, BytecodeMappingTracer tracer) {
        ...
        if (classDef) {
            ...
            if (definition) {
                if (processor != null
                        && processor.getVarFinal(varVersion)
            ...
            buffer.append(
                    name == null
                            ? ("var" + index + (this.version == 0 ? "" : "_" + this.version))
                            : name);
        }
    ...
    public String getDebugName(StructMethod method) {
        ...
        if (attr != null && processor != null) {
            ...
            if (origIndex != null) {
                ...
                if (name != null
                        && TextUtil.isValidIdentifier(
                                name, method.getClassStruct().getBytecodeVersion())) {
                    return name;
                }
            }
        }
            ...
            if (method != null) {
                ...
                if (originalIndex != null) {
                    ...
                    if (DecompilerContext.getOption(
                            IFernflowerPreferences.DECOMPILE_GENERIC_SIGNATURES)) {
                        StructLocalVariableTypeTableAttribute attr =
                                method.methodStruct.getAttribute(
                                        StructGeneralAttribute.ATTRIBUTE_LOCAL_VARIABLE_TYPE_TABLE);
                        if (attr != null) {
                            String signature = attr.getSignature(originalIndex, visibleOffset);
                            if (signature != null) {
                                GenericFieldDescriptor descriptor =
                                        GenericMain.parseFieldSignature(signature);
                                if (descriptor != null) {
                                    buffer.append(
                                            GenericMain.getGenericCastTypeName(descriptor.type));
                                    return;
                                }
                            }
                        }
                    ...
                    StructLocalVariableTableAttribute attr =
                            method.methodStruct.getLocalVariableAttr();
                    if (attr != null) {
