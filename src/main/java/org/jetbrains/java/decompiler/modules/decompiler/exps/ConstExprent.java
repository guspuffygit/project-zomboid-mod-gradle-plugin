...
public class ConstExprent extends Exprent {
    ...
    private ConstExprent(
            VarType constType, Object value, boolean boolPermitted, Set<Integer> bytecodeOffsets) {
        super(EXPRENT_CONST);
        ...
        switch (constType.type) {
            ...
            case CodeConstants.TYPE_OBJECT:
                if (constType.equals(VarType.VARTYPE_STRING)) {
                    return new TextBuffer(convertStringToJava(value.toString(), ascii))
                            .enclose("\"", "\"");
    ...
    public boolean hasBooleanValue() {
        switch (constType.type) {
            ...
            case CodeConstants.TYPE_INT:
                ...
                return value == 0
                        || (DecompilerContext.getOption(IFernflowerPreferences.BOOLEAN_TRUE_ONE)
                                && value == 1);
        }
    ...
    public void adjustConstType(VarType expectedType) {
        ...
        if ((expectedType.equals(VarType.VARTYPE_CHAR)
                        || expectedType.equals(VarType.VARTYPE_CHARACTER))
                && (constType.equals(VarType.VARTYPE_BYTECHAR)
                        || constType.equals(VarType.VARTYPE_SHORTCHAR))) {
        ...
        // BYTE, BYTECHAR, SHORTCHAR, SHORT, CHAR => INT in the INT context
                        ...
                        || expectedType.equals(VarType.VARTYPE_INTEGER))
    ...
    public boolean match(MatchNode matchNode, MatchEngine engine) {
        ...
        for (Entry<MatchProperties, RuleValue> rule : matchNode.getRules().entrySet()) {
            ...
            if (key == MatchProperties.EXPRENT_CONSTTYPE) {
                ...
                if (value.isVariable()
                        && !engine.checkAndSetVariableValue(value.value.toString(), this.value)) {
                    return false;
                }
            }
        }
