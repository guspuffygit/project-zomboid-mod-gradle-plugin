...
public final class ExitHelper {
    ...
    private static int integrateExits(Statement stat) {
            ...
            if (stat.type == Statement.TYPE_IF) {
                ...
                if (ifst.getIfstat() == null) {
                    ...
                    if (dest != null) {
                        ...
                        StatEdge newedge =
                                new StatEdge(StatEdge.TYPE_REGULAR, ifst.getFirst(), bstat);
                        ...
                        StatEdge newexitedge =
                                new StatEdge(
                                        StatEdge.TYPE_BREAK, bstat, oldexitedge.getDestination());
        ...
        if (stat.getAllSuccessorEdges().size() == 1
            ...
            if (stat != parent.getFirst()
                    || (parent.type != Statement.TYPE_IF && parent.type != Statement.TYPE_SWITCH)) {
                ...
                if (dest != null) {
                    ...
                    StatEdge oldexitedge = dest.getAllSuccessorEdges().get(0);
                    StatEdge newexitedge =
                            new StatEdge(StatEdge.TYPE_BREAK, bstat, oldexitedge.getDestination());
                    bstat.addSuccessor(newexitedge);
                    oldexitedge.closure.addLabeledEdge(newexitedge);
                    ...
                    // LabelHelper.lowContinueLabels not applicable because of forward continue
                    // edges
                    ...
                    for (StatEdge prededge : block.getPredecessorEdges(StatEdge.TYPE_CONTINUE)) {
                        ...
                        prededge.getSource()
                                .changeEdgeNode(Statement.DIRECTION_FORWARD, prededge, stat);
                    ...
                    for (StatEdge edge : dest.getAllPredecessorEdges()) {
                        if (!edge.explicit
                            ...
                            edge.getSource()
                                    .changeEdgeNode(Statement.DIRECTION_FORWARD, edge, bstat);
                ...
                if (ed.getType() == StatEdge.TYPE_REGULAR) {
                    ...
                    if (source.type == Statement.TYPE_BASICBLOCK
                            ...
                            || (source.type == Statement.TYPE_DO
                                    && ((DoStatement) source).getLooptype()
                                            != DoStatement.LOOP_DO)) {
                        return false;
                    }
                } else {
