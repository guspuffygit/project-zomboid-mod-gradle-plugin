...
public final class GenericMain {
    ...
    public static GenericClassDescriptor parseClassSignature(String signature) {
        ...
        try {
            ...
            signature =
                    parseFormalParameters(signature, descriptor.fparameters, descriptor.fbounds);
            ...
            DecompilerContext.getLogger()
                    .writeMessage(
                            "Invalid signature: " + original, IFernflowerLogger.Severity.WARN);
            return null;
        }
    }
    ...
    public static GenericFieldDescriptor parseFieldSignature(String signature) {
        try {
            ...
            DecompilerContext.getLogger()
                    .writeMessage(
                            "Invalid signature: " + signature, IFernflowerLogger.Severity.WARN);
            return null;
        }
    }
    ...
    public static GenericMethodDescriptor parseMethodSignature(String signature) {
        ...
        try {
            ...
            return new GenericMethodDescriptor(
                    typeParameters,
                    typeParameterBounds,
                    parameterTypes,
                    returnType,
    ...
    private static String parseFormalParameters(
            String signature,
            List<? super String> parameters,
            List<? super List<GenericType>> bounds) {
