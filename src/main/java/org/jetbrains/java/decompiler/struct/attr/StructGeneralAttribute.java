...
public class StructGeneralAttribute {
    ...
    public static final Key<StructAnnotationParameterAttribute>
    ...
    public static final Key<StructTypeAnnotationAttribute>
            ATTRIBUTE_RUNTIME_VISIBLE_TYPE_ANNOTATIONS = new Key<>("RuntimeVisibleTypeAnnotations");
    public static final Key<StructTypeAnnotationAttribute>
    ...
    public static final Key<StructLocalVariableTypeTableAttribute>
            ATTRIBUTE_LOCAL_VARIABLE_TYPE_TABLE = new Key<>("LocalVariableTypeTable");
    ...
    public static StructGeneralAttribute createAttribute(String name) {
        ...
        } else if (ATTRIBUTE_RUNTIME_VISIBLE_ANNOTATIONS.getName().equals(name)
                || ATTRIBUTE_RUNTIME_INVISIBLE_ANNOTATIONS.getName().equals(name)) {
        ...
        } else if (ATTRIBUTE_RUNTIME_VISIBLE_TYPE_ANNOTATIONS.getName().equals(name)
                || ATTRIBUTE_RUNTIME_INVISIBLE_TYPE_ANNOTATIONS.getName().equals(name)) {
        ...
        } else if (ATTRIBUTE_SYNTHETIC.getName().equals(name)
                || ATTRIBUTE_DEPRECATED.getName().equals(name)) {
