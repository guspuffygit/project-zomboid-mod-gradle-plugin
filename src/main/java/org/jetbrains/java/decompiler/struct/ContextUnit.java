        ...
        switch (type) {
                ...
                for (int i = 0; i < classes.size(); i++) {
                    ...
                    if (entryName != null) {
                        ...
                        if (content != null) {
                            ...
                            resultSaver.saveClassFile(
                                    filename, cl.qualifiedName, entryName, content, mapping);
                        }
                    }
                }
            ...
            case TYPE_ZIP:
                ...
                for (int i = 0; i < classes.size(); i++) {
                    ...
                    if (entryName != null) {
                        String content = decompiledData.getClassContent(cl);
                        resultSaver.saveClassEntry(
                                archivePath, filename, cl.qualifiedName, entryName, content);
                    }
                }
