...
public class ExceptionRangeCFG {
    ...
    public ExceptionRangeCFG(
            List<BasicBlock> protectedRange, BasicBlock handler, List<String> exceptionType) {
    ...
    public String getUniqueExceptionsString() {
        return exceptionTypes != null
                ? exceptionTypes.stream().distinct().collect(Collectors.joining(":"))
                : null;
    }
}
