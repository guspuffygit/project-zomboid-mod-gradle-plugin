...
public class Utils {
     ...
     * @throws IOException if path or any file in the subtree rooted at it can't be deleted for any
     *     reason.
     */
     ...
     * @throws IOException if unable to find resource for given path or an I/O error occurred while
     *     retrieving or writing resource as stream.
     */
    public static void readResourceAsFileFromStream(Class<?> clazz, String path, File file)
            throws IOException {
     ...
     * @param path path to the resource to read.
     * @throws IOException if unable to find resource for given path or an I/O error occurred while
     *     retrieving resource as stream for class loader.
     */
    public static String readResourceAsTextFromStream(Class<?> clazz, String path)
            throws IOException {
    ...
    /**
     * Reads text from a given file. The lines do not include line-termination characters, but do
    ...
    /**
     * Finds the resource {@code File} with the given path. A resource is some data (images, audio,
