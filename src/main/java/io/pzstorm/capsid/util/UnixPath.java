...
/**
 * This object represents a Unix-style path that uses <i>forward slashes</i>. This contrasts with
 * paths in MS-DOS and similar operating systems (such as FreeDOS) and the Microsoft Windows
 * operating systems, in which directories and files are separated with backslashes. The backslash
 * is an upward-to-the-left sloping straight line character that is a mirror image of the forward
 * slash.
 *
 * <ul style="list-style-type:none">
 *   <li>Unix path: {@code C:/path/to/file}
 *   <li>Windows path: {@code C:\path\to\file}
 * </ul>
 *
...
public class UnixPath {
     ...
     *
     * @throws java.nio.file.InvalidPathException if the path {@code String}cannot be converted to a
     *     {@code Path}
     */
    ...
    /**
     * Convert the given path to a standard Java {@code Path}. Use this method when you don't want
     * to instantiate a {@code UnixPath} object and just want a quick conversion to a
     * <i>Unix-style</i> path.
     */
