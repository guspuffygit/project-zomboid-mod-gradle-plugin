...
public class GradleRunConfig extends XMLDocument {
    ...
    // @formatter:off
    public static final GradleRunConfig SETUP_WORKSPACE =
            new GradleRunConfig(
                    "setupWorkspace",
                    ImmutableMap.<String, OptionType>builder()
                            ...
                            .build());
    public static final GradleRunConfig INITIALIZE_MOD =
            new GradleRunConfig(
                    "initializeMod",
                    ImmutableMap.of(
                            ...
                            ModTasks.APPLY_MOD_TEMPLATE.name,
                                    OptionType.BEFORE_RUN_TASK)); // @formatter:on
