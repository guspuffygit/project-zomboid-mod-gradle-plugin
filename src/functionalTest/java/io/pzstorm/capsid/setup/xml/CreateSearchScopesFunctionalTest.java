...
class CreateSearchScopesFunctionalTest extends PluginFunctionalTest {
    ...
    private static final ImmutableMap<ModSearchScope, String> SEARCH_SCOPES =
            ImmutableMap.of(
    ...
    private static final ImmutableMap<ModSearchScope, String[]> SEARCH_SCOPES_SUBPROJECT =
            ImmutableMap.of(
                    ModSearchScope.MOD_LUA, new String[] {"mod_lua.xml", "mod_lua_subproject.xml"},
                    ModSearchScope.MOD_MEDIA,
                            new String[] {"mod_media.xml", "mod_media_subproject.xml"});
    ...
    void shouldWriteToFileModSearchScopes() throws IOException {
        ...
        BuildResult result =
                getRunner().withArguments(SetupTasks.CREATE_SEARCH_SCOPES.name).build();
    ...
    void shouldWriteToRootProjectModSearchScopes() throws IOException {
        ...
        writeToProjectFile("settings.gradle", new String[] {"include 'subproject'"});
